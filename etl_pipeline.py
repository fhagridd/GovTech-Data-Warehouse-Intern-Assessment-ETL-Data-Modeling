...
if __name__ == '__main__':
    #Defines names of input and output files
    orders_file = 'data/orders.csv'
    products_file = 'data/products.csv'
    database_file = 'sales_analytics.db'

    #Step 1: Run extract function to get data.
    orders, products = extract_data(orders_file, products_file)

    #Step 2: Run the transform function to prepare the data.
    transformed_data = transform_data(orders, products)

    #Step3: Run the load function to save data to the database.
